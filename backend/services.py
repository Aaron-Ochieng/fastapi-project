...
async def _lead_selector(user:_schemas.User,db:_orm.Session,lead_id:int):
    lead = (
...
async def get_lead(
    ...
    lead = await _lead_selector(user=user, db=db, lead_id=lead_id)
    return _schemas.Lead.from_orm(lead)
...
async def delete_lead(
    ...
    lead = await _lead_selector(user=user,lead_id=lead_id,db=db)
    db.delete(lead)
    db.commit()
...
async def update_lead(
    ...
    lead_db = await _lead_selector(user, db, lead_id)
